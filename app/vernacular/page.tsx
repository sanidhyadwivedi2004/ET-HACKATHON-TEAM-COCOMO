...
const LANGUAGES = [
  {
    ...
    name: "Hindi",
    native: "हिंदी",
    region: "North India · UP · Bihar · Delhi NCR",
  },
  {
    code: "ta",
    name: "Tamil",
  ...
  },
  {
    ...
    name: "Telugu",
    native: "తెలుగు",
    region: "Andhra Pradesh · Telangana · Hyderabad",
  },
  {
    code: "bn",
    name: "Bengali",
...
export default function Vernacular() {
  ...
  const levelConf = result
    ? LEVEL[result.readingLevel] || LEVEL.intermediate
    : null;
  ...
  return (
    <div className="max-w-5xl mx-auto px-5 py-10">
      <div className="mb-8 pb-5" style={{ borderBottom: "3px solid #C8102E" }}>
        ...
        <h1 className="et-headline text-3xl mb-2" style={{ color: "#1a2744" }}>
          Vernacular Engine
        </h1>
        <p className="sans text-sm leading-relaxed" style={{ color: "#555" }}>
          Business news adapted for regional audiences — with local analogies,
          cultural context, and simplified jargon. Not literal translation.
        </p>
      </div>
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <span
                  className="sans text-xs font-black px-2 py-0.5 rounded-sm"
                  style={{
              ...
              <div
                className="sans text-sm font-bold"
                style={{ color: "#1a2744" }}
              >
                {l.name}
              </div>
              <div
                ...
                style={{
                  color: active ? "#C8102E" : "#777",
                  fontFamily: "system-ui, sans-serif",
                }}
              >
                {l.native}
              </div>
              <div className="sans text-xs mt-1" style={{ color: "#999" }}>
                {l.region}
              </div>
            </button>
          );
      ...
      >
        <div className="flex items-center justify-between mb-3">
          <span
            className="sans text-xs font-semibold"
            style={{ color: "#777" }}
          >
            English Article
          </span>
          <span className="sans text-xs" style={{ color: "#bbb" }}>
        ...
        <textarea
          ...
          rows={5}
          className="sans w-full bg-transparent text-sm outline-none resize-none leading-relaxed"
          style={{ color: "#1a1a1a" }}
        />
        <div
      ...
      {loading && (
        ...
        >
          <div className="progress-bar mb-5 mx-auto w-48">
            <div className="progress-bar-fill" />
          </div>
          <p
            className="sans text-sm font-semibold"
            style={{ color: "#1a2744" }}
          >
            Culturally adapting for {lang.name} audience
          </p>
          <p className="sans text-xs mt-1" style={{ color: "#777" }}>
            Adding local context, analogies, and regional relevance...
          </p>
        </div>
      )}
      ...
      {error && (
        ...
        >
          ...
          <span className="sans text-sm" style={{ color: "#991b1b" }}>
            {error}
          </span>
        </div>
      )}
                ...
                <div className="flex items-center gap-3">
                  {result.audienceRelevanceScore && (
                    <div className="text-right">
                      <div className="sans text-xs" style={{ color: "#999" }}>
                        Relevance
                      </div>
                      <div
                        className="et-headline text-lg"
                        style={{ color: "#C8102E" }}
                      >
                        {result.audienceRelevanceScore}%
                      </div>
              ...
              <div className="p-6">
                <AnimatePresence mode="wait">
                  {showOriginal ? (
                    ...
                    >
                      <div
                        className="sans text-xs font-bold mb-3 uppercase tracking-wider"
                        style={{ color: "#999" }}
                      >
                        Original English
                      </div>
                      <p
                        className="sans text-sm leading-relaxed"
                        style={{ color: "#555" }}
                      >
                        {article}
                      </p>
                    ...
                    >
                      <h2
                        className="et-headline text-lg mb-4"
                        style={{ color: "#1a2744" }}
                      >
            ...
            {result.localAngle && (
              ...
              >
                ...
                <p
                  ...
                  style={{ color: "#444", fontFamily: "system-ui, sans-serif" }}
                >
                  {result.localAngle}
                </p>
                {result.localCompaniesAffected?.length > 0 && (
                  ...
                  >
                    ...
                    {result.localCompaniesAffected.map(
                      (c: string, i: number) => (
                        <span
                          key={i}
                          className="sans badge"
                          style={{ background: "#fce8e8", color: "#C8102E" }}
                        >
                          {c}
                        </span>
                      ),
                ...
                <div className="space-y-3">
                  {result.keyTermsGlossary.map((term: any, i: number) => (
                    <div
                      ...
                      style={{ background: "#f8f8f8", borderRadius: "3px" }}
                    >
